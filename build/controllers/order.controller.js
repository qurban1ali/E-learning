...
const order_service_1 = require("../serivces/order.service");
...
exports.CreateOrder = (0, catchAsyncErrors_1.CatchAsyncErrors)(async (req, res, next) => {
    try {
        ...
        if (courseExistInUser) {
            return next(new ErrorHandler_1.default("You have already puchased this course", 400));
        }
...
// ✅ Corrected version
exports.sendStripePublishKey = (0, catchAsyncErrors_1.CatchAsyncErrors)(async (req, res) => {
    res.status(200).json({
